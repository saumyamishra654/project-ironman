...
- **Week 5 (Sep 7–13) — sprint↔easy flip to protect the rescheduled TT.** 5K TT is Wed Sep 9. Sprints cook the legs ~2 days while still novel (this is what ruined the Sep 2 TT attempt — sprints were Mon, TT Wed). So for Week 5: **Mon = easy run, Fri = sprint (Wk5 acceleration session)**, keeping the sprints AFTER the TT. General steady-state (sprint Mon / easy Fri) can resume once sprint DOMS adapts (a few sessions in) — revisit then. Watch updated: acceleration session Fri Sep 11.
