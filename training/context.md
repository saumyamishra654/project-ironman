...
- **Aug 20 (week 2) — CSS test STILL OWED.** Week 2 plan calls for the 400+200 all-out TT to set CSS pace. The Aug 20 AM swim was controlled 272 m endurance reps, NOT the maximal test — no CSS number produced. **Do the 400+200 TT on a rested day before Week 2 closes (Aug 23).** Don't test on a depleted body (would give a garbage number).
